<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <div class="relative max-w-md mx-auto">
        <label for="search-field" class="sr-only">
            <?php _e('Search for:', 'woomag-theme'); ?>
        </label>
        <input
            type="search"
            id="search-field"
            ...
            placeholder="<?php echo esc_attr_x('Search...', 'placeholder', 'woomag-theme'); ?>"
        ...
        <button
            ...
            aria-label="<?php echo esc_attr_x('Search', 'submit button', 'woomag-theme'); ?>"
        >
